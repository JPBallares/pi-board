...
function createTask({ title, description, sprint_id, status, type, assignee_id, assigneeName, assigneeColor, priority, order, labelIds, due_date, estimate, dependsOnIds }) {
...
function enrichTask(task) {
  ...
  return { ...task, labels, assignee, depends_on, blocking, subtasks };
}
